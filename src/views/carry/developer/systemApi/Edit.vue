...
export default {
  ...
  data () {
    return {
      ...
      serviceList: [
        { id: "carry-authority-server", name: "权限服务" },
        { id: "carry-file-server", name: "文件服务" },
        { id: "carry-msgs-server", name: "消息服务" },
        { id: "carry-demo-server", name: "演示服务" },
        { id: "carry-order-server", name: "订单服务" },
      ]
    }
  },
  computed: {
