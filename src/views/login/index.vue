    ...
    <el-form :model="loginForm" :rules="rules" autocomplete="off" class="login-form" label-position="left" ref="loginForm">
      ...
      <span v-if="login.type === 'up'">
        <el-form-item prop="tenant" v-show="isMultiTenant">
          <el-input :placeholder="$t('login.tenant')" @keyup.enter.native="handleLogin" autocomplete="off" name="tenantView" prefix-icon="el-icon-user" ref="tenant" type="text"
            v-model="loginForm.tenantView" />
        </el-form-item>
        <el-form-item prop="account">
          <el-input :placeholder="$t('login.username')" @keyup.enter.native="handleLogin" autocomplete="off" name="account" prefix-icon="el-icon-user" ref="account" type="text"
            v-model="loginForm.account" />
        </el-form-item>
        <el-form-item prop="password">
          <el-input :placeholder="$t('login.password')" :show-password="true" @keyup.enter.native="handleLogin" autocomplete="off" name="password" prefix-icon="el-icon-key" ref="password"
            type="password" v-model="loginForm.password" />
        </el-form-item>
        <el-form-item class="code-input" prop="code">
          <el-input :placeholder="$t('login.code')" @keyup.enter.native="handleLogin" autocomplete="off" name="code" prefix-icon="el-icon-lock" ref="code" style="width: 70%" type="text"
            v-model="loginForm.code" />
        </el-form-item>
        <img :src="imageCode" @click="getCodeImage" alt="codeImage" class="code-image" />
        <el-button :loading="loading" @click.native.prevent="handleLogin" style="width:100%;margin-bottom:7px;" type="primary">{{ $t("login.logIn") }}</el-button>
      </span>
        ...
        <el-tabs @tab-click="handleTabClick" v-model="tabActiveName">
          <el-tab-pane :label="$t('common.bindLogin')" name="bindLogin">
            ...
            <el-form-item prop="bindPassword">
              <el-input :placeholder="$t('login.password')" :show-password="true" autocomplete="off" name="bindPassword" prefix-icon="el-icon-key" ref="bindPassword" type="password"
          ...
          <el-tab-pane :label="$t('common.signLogin')" name="signLogin">
            ...
            <el-form-item prop="signPassword">
              <el-input :placeholder="$t('login.password')" :show-password="true" autocomplete="off" name="signPassword" prefix-icon="el-icon-key" ref="signPassword" type="password"
